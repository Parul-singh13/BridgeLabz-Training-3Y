...
public static void main(String[] args){
     Scanner sc = new Scanner(System.in);
        ...
        int end = sc.nextInt();
        String ssByCharAt = substringUsingCharAt(text,start , end);
        String substringBuiltIn = text.substring(start, end);

        boolean isEqual = compareStringsCharAt(ssByCharAt, substringBuiltIn);

        System.out.println("Substring using charAt(): " + ssByCharAt);
