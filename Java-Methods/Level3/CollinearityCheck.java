public class CollinearityCheck {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Using slope method, are points collinear? " + areCollinearBySlope(x1, y1, x2, y2, x3, y3));
        System.out.println("Using area method, are points collinear? " + areCollinearByArea(x1, y1, x2, y2, x3, y3));
    }
}
